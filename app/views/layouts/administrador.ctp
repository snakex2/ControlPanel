...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <!-- <link href="http://localhost/cakephp-1.3.20/css/bootstrap.min.css" rel="stylesheet"> -->
    <?php echo $this->Html->css("bootstrap.min.css");?>
    <!-- Custom CSS -->
    <!-- <link href="http://localhost/cakephp-1.3.20/css/sb-admin.css" rel="stylesheet"> -->
    <?php echo $this->Html->css("sb-admin.css");?>
    <!-- Morris Charts CSS -->
    <!-- <link href="http://localhost/cakephp-1.3.20/css/plugins/morris.css" rel="stylesheet"> -->
     <?php echo $this->Html->css("plugins/morris.css");?>
    <!-- Custom Fonts -->
    <!-- <link href="http:/localhost/cakephp-1.3.20/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"> -->
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="list_post">Listado</a>
                            </li>
                            <li>
                                <a href="post">Nueva Publicacion</a>
                            </li>
                            <li>
                                <a href="list_autor">Listado de Autores</a>
                            </li>
                            <li>
                                <a href="autor">Nuevo Autor</a>
                            </li>
                        </ul>
                    </li>
